...
// Violation 1: Intention Revealing Names => Double to ValueTransformer
...
public class Double {
  ...
  public Integer number() {
    ...
    // Violation 8: use pronouncable names => nmbr to number
    ...
    for (Integer nmbr : numbers) {
      ...
      if (nmbr % 2 == 0 && nmbr > 3) {
        // Violation 12: Scope Rule intF is shorter then nmbr, yet intF has larger scope
        intF = nmbr;
        break;
      }
    }
